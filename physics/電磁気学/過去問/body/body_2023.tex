...
\end{align}
ただし問題文では $\mathbf{i}_M$ を「電流密度」として与えているので、$\nabla\times\mathbf{B} = \mu_0(\mathbf{i} + \mathbf{i}_M)$ と書いておく。$\mathbf{i}_M = \nabla\times\mathbf{M}/\mu_0$ なら $\nabla\times\mathbf{B} = \mu_0\mathbf{i} + \nabla\times\mathbf{M}$ である。
...
%----------------------------------------------------------------------
\section{問題3：金属表面における平面電磁波の反射と透過}
%----------------------------------------------------------------------
