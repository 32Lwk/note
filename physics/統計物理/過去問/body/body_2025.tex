...
$S = NR \ln[(U/N)^{3/2}(V/N)^2] + N S_0$ であり、
\[
\ln[(U/N)^{3/2}(V/N)^2] = \frac{3}{2}\ln(U/N) + 2\ln(V/N)
\]
...
\end{equation}
エントロピー変化は、初期 $S_{\mathrm{i}} = NR\ln[(U/N)^{3/2}(V/N)^2] + NS_0$、\\
終状態 $S_{\mathrm{f}} = NR\ln[(U''/N)^{3/2}(V/N)^2] + NS_0$ である。
$U'' = (3/2)N R T''$ なので
\begin{equation}
